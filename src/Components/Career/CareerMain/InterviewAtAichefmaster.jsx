...
function InterviewAtAichefmaster() {
  return (
    <div className='flex pb-6 gap-y-3 flex-col px-9 pt-6 md:mt-12 mt-4  font-bold ' style={{"background-image":" linear-gradient(#08C8F3, #F1F7F9)"}}>
     ...
     <p className=' w-[13rem] py-3 rounded-3xl text-center font-bold  text-[1rem] md:text-[1.5rem]' style={{"background-image":" linear-gradient(#17CBF3, #A9E6F4)"}} >Find a Career</p> </div>
    </div>
  )
}
